...
export const EditCharacterModal: React.FC<EditCharacterModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedChar: Character = {
      ...
      category,
      status,
      avatar: avatarUrl.trim() || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800',
      avatarUrl: avatarUrl.trim() || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800',
      shortDescription: bio.trim() || 'Chưa có thông tin tóm tắt.',
      introduction: initialMessage.trim() || 'Xin chào!',
      plot: backstory.trim() || bio.trim() || 'Chưa có cốt truyện chi tiết.',
      chatLink: 'https://c.ai/',
